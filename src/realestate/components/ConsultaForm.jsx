        ...
        <>
            ...
            <div>
                <form onSubmit={handleSubmit(onSubmit)} className="bg-gray-100 p-6 rounded-lg shadow-md space-y-3 h-full">
                    ...
                    <div className="flex flex-col space-y-2">
                        <input type="submit" className="w-full p-2 bg-blue-600 text-white rounded-md hover:bg-blue-500 transition-all duration-300" />
                    </div>
                    ...
                    <div className=" grid grid-cols-2  ">
                        ...
                        <div >
                            ...
                            <a href="#" className="flex flex-col space-y-2 w-full p-2 bg-blue-600 text-white rounded-md hover:bg-blue-500 transition-all duration-300">Máximo</a>
                            <a href="#" className="flex flex-col space-y-2 w-full p-2 bg-blue-600 text-white rounded-md hover:bg-blue-500 transition-all duration-300">Mínimo</a>
                        </div>
                        <div>
                            <Graphics />
                        </div>
