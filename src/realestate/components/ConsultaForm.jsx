  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await dataFetch(
        "http://127.0.0.1:3500/api/predict",
        "POST",
        data
      );
      ...
      if (response.ok) {
        ...
        const user = await dataFetch(
          "http://localhost:3000/api/v1/consulta/crear",
          "POST",
          body
        );
        console.log(user);
    ...
    <>
      <div className="flex flex-wrap justify-center ">
        ...
        <form
          ...
          className="bg-gray-100 p-14 rounded-lg shadow-md space-y-3 h-full min-w-fit  m-4 "
        >
          ...
          <div className="flex flex-col space-y-2">
            ...
            >
              ...
              {distritosArray.map((distrito) => (
                <option value={distrito} key={distrito}>
                  {distrito}
                </option>
              ))}
            </select>
          ...
          <div className="flex flex-col space-y-2">
            ...
            <input
              {...register("banos", {
                required: "Necesitamos conocer el número de baños",
                min: 1,
              })}
              type="number"
              name="banos"
          ...
          <input
            {...register("furnished", {
              required: "Por favor, indique si la propiedad es amueblada",
            })}
            type="radio"
            name="furnished"
            value="1"
          ...
          <input
            {...register("condicion", {
              required: "Por favor, indique la condicion de la propiedad",
            })}
            type="radio"
            name="condicion"
            value="normal"
            ...
            <div className="flex flex-col justify-center p-6 bg-gray-100 rounded-lg shadow-md text-center h-full">
              <>
                ...
                <p className="text-xl text-gray-800">
                  Basado en su búsqueda, la predicción mensual para su estadía
                  de larga duración es de:
                </p>
                ...
                <p className="pb-4 font-bold text-green-800 ">
                  {data.fiabilidad}
                </p>
