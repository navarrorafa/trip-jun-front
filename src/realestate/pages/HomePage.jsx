...
export const HomePage = () => {
  ...
  return (
    ...
    <div className="container mx-auto">
        <h3 className="text-2xl font-semibold mb-6 text-center">Tipo de Estancia</h3>
        
      
        <div className="flex justify-center space-x-4 mb-6">
            <button
                onClick={() => setMostrarFormulario('corta')}
                className="p-2 bg-blue-600 text-white rounded-md hover:bg-blue-500 transition-all duration-300">
                Curta Duracion
            </button>
            <button
